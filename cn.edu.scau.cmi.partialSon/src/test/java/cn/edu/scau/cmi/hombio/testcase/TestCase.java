...
public class TestCase {
	...
	private static void testNull() throws IllegalArgumentException, IllegalAccessException {
		System.out.println(hombioSon.toPartialJson(null, PartialSon.Flag.FIRST_TIME));
	}

	private static void testBasicType() throws IllegalArgumentException, IllegalAccessException {
		System.out.println("测试基本类型");
		int a = 1;
		System.out.println(hombioSon.toPartialJson(a, PartialSon.Flag.FIRST_TIME));
		float b = (float) 3.14;
		System.out.println(hombioSon.toPartialJson(b, PartialSon.Flag.FIRST_TIME));
		double c = (double) 3.14159;
		System.out.println(hombioSon.toPartialJson(c, PartialSon.Flag.FIRST_TIME));
		long d = new Long(88888888);
		System.out.println(hombioSon.toPartialJson(d, PartialSon.Flag.FIRST_TIME));
		byte e = 127;
		System.out.println(hombioSon.toPartialJson(e, PartialSon.Flag.FIRST_TIME));
		boolean f = false;
		System.out.println(hombioSon.toPartialJson(f, PartialSon.Flag.FIRST_TIME));
		char g = 0;
		System.out.println(hombioSon.toPartialJson(g, PartialSon.Flag.FIRST_TIME));
	}
	...
	private static void testListObject() throws IllegalArgumentException, IllegalAccessException {
		...
		System.out.println(hombioSon.toPartialJson(list, PartialSon.Flag.FIRST_TIME));
	...
	private static void testBasicObject() throws IllegalArgumentException, IllegalAccessException {
		...
		System.out.println(hombioSon.toPartialJson(str, PartialSon.Flag.FIRST_TIME));
		System.out.println(new Gson().toJson(str));
		Date date = new Date();
		System.out.println(hombioSon.toPartialJson(date, PartialSon.Flag.FIRST_TIME));
		System.out.println(new Gson().toJson(date));
		Calendar calendar = Calendar.getInstance();
		System.out.println(hombioSon.toPartialJson(calendar, PartialSon.Flag.FIRST_TIME));
	...
	private static void testArray() throws IllegalArgumentException, IllegalAccessException {
		...
		System.out.println(hombioSon.toPartialJson(strArray, PartialSon.Flag.FIRST_TIME));
		...
		Number[] numberArray = { new Integer(100), new Double(3.14159), new Float(1.1314), new Byte((byte) 88),
				new Long(1314520) };
		System.out.println(hombioSon.toPartialJson(numberArray, PartialSon.Flag.FIRST_TIME));
		System.out.println(new Gson().toJson(numberArray));
		Course[] courseArray = { new Course("语文"), new Course("数学"), new Course("英语") };
		System.out.println(hombioSon.toPartialJson(courseArray, PartialSon.Flag.FIRST_TIME));
	...
	private static void testCompositeObject() throws IllegalArgumentException, IllegalAccessException {
		...
		System.out.println(hombioSon.toPartialJson(stu, PartialSon.Flag.FIRST_TIME));
	...
	private static void testCycleCompositeObject() throws IllegalArgumentException, IllegalAccessException {
		...
		System.out.println(hombioSon.toPartialJson(student, PartialSon.Flag.FIRST_TIME));
		System.out.println(hombioSon.toPartialJson(teacher, PartialSon.Flag.FIRST_TIME));
		// 这里将报错，因为存在循环链
...
//	测试组合对象集合？？？--by liang zaoqing
	private static void testCompositeObjectSet() throws IllegalArgumentException, IllegalAccessException {
		...
		System.out.println(hombioSon.toPartialJson(students, PartialSon.Flag.FIRST_TIME));
		System.out.println(new Gson().toJson(students));
		Map<String, Student> map = new HashMap<>();
		map.put("1", new Student());
		map.put("2", new Student("陈宏彪"));
		System.out.println(hombioSon.toPartialJson(map, PartialSon.Flag.FIRST_TIME));
		System.out.println(new Gson().toJson(map));
		Map<Teacher, Student> map1 = new HashMap<>();
		map1.put(new Teacher(), new Student());
		System.out.println(hombioSon.toPartialJson(map1, PartialSon.Flag.FIRST_TIME));
