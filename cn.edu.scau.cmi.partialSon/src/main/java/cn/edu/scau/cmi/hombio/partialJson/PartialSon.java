...
//	将对象转换为Pson对象
	public String toPartialJson(Object object, Flag flag) throws IllegalArgumentException, IllegalAccessException {
		...
		if (object instanceof Collection) {
			...
			for (Object key : map.keySet()) {
				...
				partialJsonStringBuilder.append(toPartialJson(key, flag)).append(":").append(toPartialJson(value, flag))
						.append(",");
			}
			if (partialJsonStringBuilder.length() > 1) {
				partialJsonStringBuilder.deleteCharAt(partialJsonStringBuilder.length() - 1);
	...
	private String getBasicObjectJson(Map<String, Object> map, Flag flag)
	...
	// 获取不是基本类型对象的对象
	private Map<String, Object> getNotBasicTypeMap(Object object)
			throws IllegalArgumentException, IllegalAccessException {
